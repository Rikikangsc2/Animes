      ...
      <body>
        <div class="container mt-5">
          ...
          <div class="mt-4">
            ...
            <ul>
              ${episodeData.list_episode.map((episode) => `
                <li>
                  <a href="/anime/${animeId}/${episodeList.length - episodeData.list_episode.indexOf(episode)}" class="btn btn-link text-decoration-none ${episode.list_episode_endpoint === selectedEpisode.episode_endpoint ? 'active' : ''}">
          ...
          <div class="iframe-container">
            ${episodeData.streamLink ? `<iframe src="${episodeData.streamLink}" frameborder="0" allowfullscreen></iframe>` : '<p>Tidak tersedia silahkan pilih pada list</p>'}
          </div>
          <div class="mt-4">
            <h3>Synopsis</h3>
